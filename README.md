...
🔗 **Live Website:**  
[https://space-tech-ashy.vercel.app/](https://space-tech-ashy.vercel.app/)

💻 **GitHub Repository:**  
[https://github.com/SujalGaikwad04/space-tech](https://github.com/SujalGaikwad04/space-tech)
...
1. User data is stored in **PostgreSQL (Neon Database)**
2. The backend checks upcoming celestial events
3. Events are matched with user location
4. If an event is approaching, an **automated email alert** is triggered using **Node.js + Nodemailer**
...
2. Add `EMAIL_USER` & `EMAIL_PASS` in `.env`
3. **Nodemailer** handles automated alerts
