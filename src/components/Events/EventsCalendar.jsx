      ...
      <div className="calendar">
        ...
        <div className="calendar-grid">
          {calendarDays.map((dayData, index) => (
            <div
              key={index}
              className={`calendar-day ${dayData.day === selectedDate ? 'selected' : ''
                    ...
                    <div className="event-indicators">
                      {dayData.events.map((event, i) => (
                        <span
                          ...
                          style={{ opacity: event.isVisible === false ? 0.3 : 1, filter: event.isVisible === false ? 'grayscale(100%)' : 'none' }}
                          title={event.isVisible === false ? "Not visible in your location" : ""}
                        >
                          {event.icon}
                        </span>
                      ))}
